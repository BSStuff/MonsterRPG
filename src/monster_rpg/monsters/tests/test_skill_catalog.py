...
from monster_rpg.monsters.bestiary import MVP_SPECIES
from monster_rpg.monsters.models import Element
from monster_rpg.monsters.skill_catalog import MVP_SKILLS
from monster_rpg.skills.progression import SkillType
