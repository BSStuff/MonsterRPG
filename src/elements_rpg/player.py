...
from elements_rpg.combat.strategy import StrategyProfile
from elements_rpg.config import BASE_ACTION_QUEUE_SLOTS, MAX_TEAM_SIZE


class Player(BaseModel):
    """Core player data model.

    Currency (gems/gold) is managed by EconomyManager, not stored here.
